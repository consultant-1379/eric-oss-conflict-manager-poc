...
*/ -}}
{{- define "eric-oss-conflict-manager-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-conflict-manager-poc.mergeAnnotations" -}}
  {{- include "eric-oss-conflict-manager-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-conflict-manager-poc.mergeLabels" -}}
  {{- include "eric-oss-conflict-manager-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
